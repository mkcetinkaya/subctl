...
import (
	...
	"github.com/mkcetinkaya/submariner-operator/pkg/client"
	"github.com/mkcetinkaya/submariner-operator/pkg/discovery/globalnet"
...
func populateSubmarinerSpec(options *SubmarinerOptions, brokerInfo *broker.Info, brokerSecret *v1.Secret, pskSecret *v1.Secret,
	...
	submarinerSpec := &submariner.SubmarinerSpec{
		...
		CeNatDiscovery:           options.NatDiscovery,
